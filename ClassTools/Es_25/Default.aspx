...
<div style="flex: 1; position: sticky; margin-top : 50px; top: 0; align-self: flex-start;">
    <h3  style="text-align: Center; width: 300px;">Products selected</h3>
        ...
        <asp:Label ID="L_TotalPrice" style="text-align: Center" runat="server" Font-Bold="True" Font-Size="Large" Text="Total : 0,00€" Width="300px"></asp:Label>
        <asp:Button ID="B_Order" runat="server" Text="Order" Width="300px" />
<asp:Button ID="B_EmptyCart" runat="server" Text="Empty Cart" Width="300px" />
        </div>
