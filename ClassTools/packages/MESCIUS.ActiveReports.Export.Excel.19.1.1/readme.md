...
This package includes the .NET and .NET Core assemblies required to export to MS Excel-specific formats (XLS/XLSX/CSV).


## Note

There are 2 exports available for Page/RDL reports:
* XLSX/XLS Layout-Driven GrapeCity.ActiveReports.Export.Excel.Page.ExcelRenderingExtension.
* XLSX/CSV Data-Only GrapeCity.ActiveReports.Export.Excel.Page.ExcelTransformationDevice.

## License

XLSX Data export is not available with a Standard Edition license.
