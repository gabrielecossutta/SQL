...
This package includes the .NET and .NET Core assemblies required to export to HTML/MHTML formats.
...
* For the US version of ActiveReports: Update here: [New Package Version](https://www.nuget.org/packages/MESCIUS.ActiveReports.Export.Html/)

* For the CN version of ActiveReports: Update here: [New Package Version](https://www.nuget.org/packages/GCCN.ActiveReports.Export.Html/)
