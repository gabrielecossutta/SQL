...
* For the US version of ActiveReports: Update here: [New Package Version](https://www.nuget.org/packages/MESCIUS.ActiveReports.Core.Rdl/)

* For the CN version of ActiveReports: Update here: [New Package Version](https://www.nuget.org/packages/GCCN.ActiveReports.Core.Rdl/)
