...
This package includes the .NET and .NET Core assemblies required to export to text-like formats (XML/JSON/TXT/CSV).

The exports' purpose is obtaining underlying data sets, they are not WYSIWYG exports.


## Note

CSV export for Page/RDL reports does not preserve table headers or column orders: if you need this - please use XLSX/CSV Data export from [MESIUS.ActiveReports.Export.Excel](https://www.nuget.org/packages/MESCIUS.ActiveReports.Export.Excel/).
