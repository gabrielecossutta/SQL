...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            isCartEmpty = True
            ProductsCart.Clear()
            If Request.Cookies("InfoOrder") Is Nothing Then
                PopulateCart()
            Else
                PopulateCartByCookie()
            End If
    ...
    Sub PopulateCart()
        ...
        Using context As New DbStructure.TotemDbContext()
            ...
            Dim userCookie As New HttpCookie("InfoOrder")
            userCookie("IdOrder") = IdCopy
    ...
    Sub PopulateCartByCookie()
        Using context As New DbStructure.TotemDbContext()
            Dim cookieValue = Request.Cookies("InfoOrder")
            IdCopy = cookieValue("IdOrder")
            isCartEmpty = False
