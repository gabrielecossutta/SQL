Public Class Login
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles B_BackOffice.Click
        OpenForm(3)
    End Sub
    Private Sub B_Synchronize_Click(sender As Object, e As EventArgs) Handles B_Synchronize.Click
        OpenForm(4)
    End Sub
    ...
    Private Sub OpenForm(par As Integer)
        ...
        Select Case par
            ...
            Case 4
                Dim SynchronizeForm As New F_Synchronize
                SynchronizeForm.ShowDialog()
