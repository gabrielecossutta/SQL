    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "La password è stata cambiata.", If(message = "SetPwdSuccess", "La password è stata impostata.", If(message = "RemoveLoginSuccess", "L'account è stato rimosso.", [String].Empty)))
